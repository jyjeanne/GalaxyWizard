...
class ScenarioChooser(MainWindow.MainWindowDelegate):
    ...
    def handleEvent(self, event):
        ...
        if self.readyToStart:
            ...
            twistedmain.startGame(
                server=self.serverAddress, scenario=self.scenario, multiplayer=self.multiplayer
            )
        return True
...
class ScenarioChooserFSM(FSM.FSM):
    def __init__(self, chooser):
        FSM.FSM.__init__(self, ["multiplayer", "hostGame", "scenario", "serverAddress", "done"])
    ...
    def enter_scenario(self, *args):
        ...
        menu = self.chooser._menu
        menu.setOptions([("Randomly Generated"), ("Hill & Ravine"), ("Wall"), ("Castle")])
