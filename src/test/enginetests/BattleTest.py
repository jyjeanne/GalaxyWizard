...
#class FooLoadingTestCase(unittest.TestCase):
#    # def setUp(self):
#    # def tearDown(self):
#    
#    def testMinimalFooLoading(self):
#        '''Load the test Example foo, verify all bits showed up'''
#        example = Resources.foo('example')
